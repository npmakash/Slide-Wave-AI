...
import { Upload, Rocket, FileText, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="form-group">
        <label htmlFor="json-template-url">Template Slide URL *</label>
        <input
          type="url"
      ...
      <div className="form-group">
        <label htmlFor="json-output-name">Output Presentation Name *</label>
        <input
          type="text"
          id="json-output-name"
          className="form-control"
